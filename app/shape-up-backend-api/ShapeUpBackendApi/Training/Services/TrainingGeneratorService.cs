...
namespace ShapeUpBackendApi.Training.Services {
    ...
    public class TrainingGeneratorService {
        ...
        private IEnumerable<Workout> CreateHypertrophyBeginnerTraining(string username) {
            ...
            yield return CreateWorkout("Treino Peito e Ombro", username, "Assets/training_1.jpeg", new List<ExerciseDetail> {
            ...
            yield return CreateWorkout("Treino Posterior e Glúteo", username, "Assets/training_2.jpeg", new List<ExerciseDetail> {
            ...
            yield return CreateWorkout("Treino Perna", username, "Assets/training_3.jpeg", new List<ExerciseDetail> {
            ...
            yield return CreateWorkout("Treino Costas e Ombro", username, "Assets/training_4.jpeg", new List<ExerciseDetail> {
            ...
            yield return CreateWorkout("Treino Braços e Abdômen", username, "Assets/training_5.jpeg", new List<ExerciseDetail> {
        ...
        private IEnumerable<Workout> CreateReductionTraining(string username) {
            ...
            yield return CreateWorkout("Treino Superior 01", username, "Assets/training_7.jpeg", new List<ExerciseDetail> {
            ...
            yield return CreateWorkout("Treino Inferior 02", username, "Assets/training_8.jpeg", new List<ExerciseDetail> {
            ...
            yield return CreateWorkout("Treino Abdômen e Lombar", username, "Assets/training_9.jpeg", new List<ExerciseDetail> {
            ...
            yield return CreateWorkout("Treino Superior 02", username, "Assets/training_10.jpeg", new List<ExerciseDetail> {
