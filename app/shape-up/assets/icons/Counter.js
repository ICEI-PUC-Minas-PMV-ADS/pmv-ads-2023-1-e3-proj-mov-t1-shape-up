...
export function Counter(props) {
    return(
      <Box flex={0} mr={3} flexDirection='row' alignItems='center' justifyContent='center'>
      <Icon style={{...props.style, alignItems: 'center', justifyContent: 'center', flex: '1'}} size='5xl' viewBox="0 0 47 36">
        ...
        <Box style={{position: 'relative', justifyContent: 'flex-end', width: 48, height: 48, paddingBottom: 3, paddingRight: 3}}>
          <Text style={{fontSize: 14, fontFamily: 'Roboto', fontWeight: 'regular', alignSelf: 'flex-end'}} color='#fff'>90s</Text>
        </Box>
      </Icon>
  </Box>
    );
