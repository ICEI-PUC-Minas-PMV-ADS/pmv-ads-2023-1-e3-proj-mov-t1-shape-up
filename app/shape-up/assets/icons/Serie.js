...
export function Serie(props) {
    return(
      ...
      <Icon style={{...props.style, position: 'relative', alignItems: 'center', justifyContent: 'center', flex: '1'}} size='5xl' viewBox="0 0 48 48">
        ...
        <Center style={{position: 'relative', width: 48, height: 48}}>
