...
export function Arm(props) {
    return(
      ...
      <Icon style={{...props.style}} size='4xl' viewBox="0 0 36 36">
        ...
        <Box style={{position: 'relative', justifyContent: 'flex-start', width: 48, height: 48, paddingBottom: 3, paddingRight: 6}}>
            <Text style={{fontSize: 14, fontFamily: 'Roboto', fontWeight: 'regular', alignSelf: 'flex-end'}} color='#fff'>15</Text>
        </Box>
      </Icon>
  </Box>
    );
